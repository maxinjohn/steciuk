...
@switch($name)
    @case('book')
        ...
        @break
    @case('music')
        <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-3.6 0l1.32-.377a2.25 2.25 0 001.632-2.163V6.553zM9 9v6.553a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-3.6 0l1.32-.377A2.25 2.25 0 015.25 15.553V9"/></svg>
        @break
    @case('people')
