...
class AdminSmokeTest extends TestCase
{
    ...
    private function adminPaths(): array
    {
        return [
            ...
            AdminPanelConfig::url('faith-comfort'),
            ...
            AdminPanelConfig::url('giving-settings'),
            AdminPanelConfig::url('content-approvals'),
            AdminPanelConfig::url('designations'),
            AdminPanelConfig::url('panels'),
